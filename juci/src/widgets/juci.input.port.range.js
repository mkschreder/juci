/*$juci.module("core")
	.directive("juciInputPortRange", function () {
		var plugin_root = $juci.module("core").plugin_root;
		return {
			templateUrl: plugin_root + "/widgets/juci.input.port.range.html",
			restrict: 'E',
			replace: true,
			scope: {
				model: "=ngModel"
			...
			controller: "juciInputPortRange"
		};
	})
	.controller("juciInputPortRange", function($scope){
		$scope.startPort = ""; 
		$scope.endPort = ""; 
